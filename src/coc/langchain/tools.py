...
from coc.rules.compiled_resolver import RulesetResolverInput, run_ruleset_resolver
from coc.tools.content import (
    LoadContentSpanInput,
    SearchContentInput,
    load_content_span,
    search_content,
)
from coc.tools.patches import ApplyWorldPatchInput
